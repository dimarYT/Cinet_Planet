 ...
 * @author Juan
 */
public class Menu_confitero extends javax.swing.JFrame {

 int xMouse, yMouse;
    public Menu_confitero() {
...
this.setSize(634,400);
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
       Dulceria_Ventas a = new Dulceria_Ventas();
      a.setVisible(true);
      this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Menu_confitero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Menu_confitero().setVisible(true);
            }
        });
    }
